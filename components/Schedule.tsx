...
const dailySections: DailySection[] = [
  {
    ...
    items: [
      ...
      { time: "7:00 – 7:10 AM", name: { en: "Hukamnama Sahib, Ardas And Smapati", pa: "ਹੁਕਮਨਾਮਾ ਸਾਹਿਬ, ਅਰਦਾਸ ਅਤੇ ਸਮਾਪਤੀ" } },
    ],
  },
  {
    ...
    items: [
      ...
      { time: "8:00 – 8:10 PM", name: { en: "Har Jas, Hukamnama, Ardas And Smapati", pa: "ਹਰ ਜਸ, ਹੁਕਮਨਾਮਾ, ਅਰਦਾਸ ਅਤੇ ਸਮਾਪਤੀ" } },
    ],
  },
  {
    ...
    items: [
      ...
      { time: "7:00 – 7:10 PM", name: { en: "Har Jas, Hukamnama, Ardas And Smapati", pa: "ਹਰ ਜਸ, ਹੁਕਮਨਾਮਾ, ਅਰਦਾਸ ਅਤੇ ਸਮਾਪਤੀ" } },
    ],
  },
];
...
const scheduleData: Record<Exclude<Tab, "calendar" | "daily" | "sunday">, Item[]> & { sunday: Item[] } = {
  sunday: [
    ...
    { time: "10:30 – 10:45 AM", name: { en: "Bhogan De Shabad And Hukamnama Sahib", pa: "ਭੋਗਣ ਦੇ ਸ਼ਬਦ ਅਤੇ ਹੁਕਮਨਾਮਾ ਸਾਹਿਬ" }, description: { en: "Closing shabads and the day's divine Hukamnama", pa: "ਭੋਗ ਦੇ ਸ਼ਬਦ ਅਤੇ ਹੁਕਮਨਾਮਾ ਸਾਹਿਬ" }, icon: Star },
    { time: "10:45 – 11:30 AM", name: { en: "Kirtan Hazari By Hazoori Jatha", pa: "ਕੀਰਤਨ ਹਜ਼ੂਰੀ — ਹਜ਼ੂਰੀ ਜੱਥਾ" }, description: { en: "Devotional kirtan by the resident Hazoori Jatha", pa: "ਹਜ਼ੂਰੀ ਜੱਥੇ ਵੱਲੋਂ ਕੀਰਤਨ" }, icon: Sun },
    ...
    { time: "12:00 – 1:00 PM", name: { en: "Kirtan Hazari By Guest Ragis Or Other", pa: "ਕੀਰਤਨ ਹਜ਼ੂਰੀ — ਮਹਿਮਾਨ ਰਾਗੀ" }, description: { en: "Kirtan Hazari by guest ragis or visiting jatha", pa: "ਮਹਿਮਾਨ ਰਾਗੀਆਂ ਵੱਲੋਂ ਕੀਰਤਨ" }, icon: Moon },
    { time: "1:00 – 1:15 PM", name: { en: "Ardas, Hukamnama And Smapati", pa: "ਅਰਦਾਸ, ਹੁਕਮਨਾਮਾ ਅਤੇ ਸਮਾਪਤੀ" }, description: { en: "Closing prayer, divine command, and congregation dismissal", pa: "ਅੰਤਿਮ ਅਰਦਾਸ, ਹੁਕਮਨਾਮਾ ਅਤੇ ਸੰਗਤ ਦੀ ਵਿਦਾਈ" }, icon: Moon },
  ],
  special: [
