...
export default function About() {
  ...
  const stats = [
    { icon: Calendar, label: t.statsYears, value: 30, suffix: "+" },
    { icon: Users, label: t.statsMembers, value: 500, suffix: "+" },
    { icon: Heart, label: t.statsWeekly, value: 14, suffix: "" },
    { icon: Star, label: t.statsAnnual, value: 25, suffix: "+" },
  ];
